...
import { regions, roles, stats } from '@/lib/data';

export default function HomeClient() {
  const { cancelSearch, phase, primaryRole, region, resetDemo, searchSeconds, secondaryRole, setPrimaryRole, setRegion, setSecondaryRole, startSearch } = useMatchmaking();
      ...
      <div className="space-y-8">
        <section id="home" className="grid items-center gap-8 py-10 lg:grid-cols-[1.15fr_.85fr]">
          <div className="space-y-7">
            ...
            <p className="max-w-2xl text-lg text-zinc-300">Выберите регион, основную и дополнительную роль, запустите поиск и пройдите полный mock-сценарий матчмейкинга TRUST.</p>
