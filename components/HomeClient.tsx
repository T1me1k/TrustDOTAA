      ...
      <div className="space-y-8">
        <section id="home" className="grid items-center gap-8 py-10 lg:grid-cols-[1.15fr_.85fr]">
          <div className="space-y-7">
            ...
            <p className="max-w-2xl text-lg text-zinc-300">{config?.content.heroText || 'Выберите регион и основную роль, запустите поиск и пройдите полный реальный backend-сценарий матчмейкинга TRUST.'}</p>
