...
export const defaultRuntimeConfig: RuntimeConfig = {
  ...
  regions:[{id:'eu-west',name:'EU West',enabled:true,status:'Live',latencyMs:32,load:61},{id:'eu-east',name:'EU East',enabled:true,status:'Live',latencyMs:48,load:54},{id:'na',name:'NA',enabled:true,status:'Live',latencyMs:88,load:43},{id:'sea',name:'SEA',enabled:true,status:'Live',latencyMs:96,load:70}],
  roles:[{id:'carry',name:'Carry',enabled:true,order:1,regions:['eu-west','eu-east','na','sea']},{id:'mid',name:'Mid',enabled:true,order:2,regions:['eu-west','eu-east','na','sea']},{id:'offlane',name:'Offlane',enabled:true,order:3,regions:['eu-west','eu-east','na','sea']},{id:'soft-support',name:'Soft Support',enabled:true,order:4,regions:['eu-west','eu-east','na','sea']},{id:'hard-support',name:'Hard Support',enabled:true,order:5,regions:['eu-west','eu-east','na','sea']}],
  ...
  admin:{storeWarning:'DEMO ADMIN: file mock-store is active until ADMIN_STORE_URL is configured.',roles:['Owner','Admin','Operator','Support','Read Only'],currentRole:'Owner'}
};
